...
#SBATCH --output=slogs/confusion-50-resnet-%j.out
#SBATCH --error=slogs/confusion-50-resnet-%j.err
#SBATCH --mem=16G
...
luigi --module deepscribe.pipeline.analysis RunAnalysisOnTestDataTask --local-scheduler \
      ...
      --model-definition data/model_defs/resnet18_earlystopping_reweight.json