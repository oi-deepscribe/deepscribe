...
#SBATCH --output=slogs/confusion-10-resnet18-%j.out
#SBATCH --error=slogs/confusion-10-resnet18-%j.err
#SBATCH --mem=16G
...
luigi --module deepscribe.pipeline.analysis RunAnalysisOnTestDataTask --local-scheduler \
      ...
      --model-definition data/model_defs/resnet18_earlystopping_reduce.json